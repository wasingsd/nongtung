// Temporary script to seed an Enduro activity
// Run with: npx ts-node --skip-project scripts/seed-enduro-activity.ts
...
async function seedActivity() {
    try {
        const docRef = doc(db, 'activities', enduroActivity.slug);
        await setDoc(docRef, enduroActivity);
        console.log('✅ Enduro activity created successfully!');
        console.log('📍 View at: http://localhost:3000/activities/enduro-samoeng-farm');
    } catch (error) {
