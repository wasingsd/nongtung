        ...
        <div className="fade-in bg-[#fdfdfb]">
            ...
            <div className="relative h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-20 text-center text-white px-6 max-w-5xl">
                    <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.5em] mb-4 md:mb-6 block drop-shadow-lg text-primary">Stronger Together</span>
                    ...
                    <div className="bg-white rounded-[2rem] md:rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 md:p-16 border border-forest/10">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
                            <div className="flex flex-col items-center text-center">
                                ...
                                <h3 className="text-lg md:text-xl font-black font-heading text-forest mb-2 md:mb-3 tracking-tighter uppercase">Team Building</h3>
                                <p className="text-xs md:text-sm font-medium text-forest/40 leading-relaxed">กิจกรรมละลายพฤติกรรมที่ออกแบบมาเพื่อดึงศักยภาพของทีมออกมาได้สูงสุดในบรรยากาศผ่อนคลาย</p>
                            </div>
                            <div className="flex flex-col items-center text-center">
                                <div className="w-14 h-14 md:w-16 md:h-16 bg-surface rounded-2xl flex items-center justify-center text-primary mb-4 md:mb-6 shadow-sm border border-forest/5">
                                    <Compass className="w-6 h-6 md:w-8 md:h-8" />
                                </div>
                                <h3 className="text-lg md:text-xl font-black font-heading text-forest mb-2 md:mb-3 tracking-tighter uppercase">Flexible Plans</h3>
                                <p className="text-xs md:text-sm font-medium text-forest/40 leading-relaxed">เลือกความยาก เส้นทาง และระดับความหรูหราของที่พักและอาหารได้ตามงบประมาณองค์กร</p>
                            </div>
                            <div className="flex flex-col items-center text-center">
                                <div className="w-14 h-14 md:w-16 md:h-16 bg-surface rounded-2xl flex items-center justify-center text-primary mb-4 md:mb-6 shadow-sm border border-forest/5">
                                    <FileText className="w-6 h-6 md:w-8 md:h-8" />
                                </div>
                                <h3 className="text-lg md:text-xl font-black font-heading text-forest mb-2 md:mb-3 tracking-tighter uppercase">E-Tax Invoice</h3>
                                <p className="text-xs md:text-sm font-medium text-forest/40 leading-relaxed">อำนวยความสะดวกด้วยการออกใบกำกับภาษีเต็มรูปแบบในระบบ e-Tax Invoice ถูกต้องแม่นยำ</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-10 md:mb-16 gap-4 md:gap-6">
                        <div className="max-w-xl">
                            <span className="text-[10px] font-black text-primary uppercase tracking-[0.3em] mb-2 md:mb-3 block">Corporate Trips</span>
                            <h2 className="text-3xl md:text-5xl font-black font-heading text-forest tracking-tighter">WHAT WE DO</h2>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
                        <div className="group relative h-[300px] md:h-[400px] overflow-hidden rounded-[2rem] md:rounded-[3rem] immersive-shadow border border-forest/5 transition-all duration-500">
                            ...
                            <div className="absolute bottom-6 left-6 right-6 md:bottom-10 md:left-10 md:right-10">
                                <h4 className="text-xl md:text-2xl font-black text-white font-heading tracking-tighter mb-2 uppercase italic">Executive Trips</h4>
                                <p className="text-xs md:text-sm text-white/60 font-medium">ทริปพักผ่อนระดับผู้บริหาร เน้นความเป็นส่วนตัวและความพรีเมียมสูงสุด</p>
                            </div>
                        </div>
                        <div className="group relative h-[300px] md:h-[400px] overflow-hidden rounded-[2rem] md:rounded-[3rem] immersive-shadow border border-forest/5 transition-all duration-500">
                            <Image
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
                            <div className="absolute bottom-6 left-6 right-6 md:bottom-10 md:left-10 md:right-10">
                                <h4 className="text-xl md:text-2xl font-black text-white font-heading tracking-tighter mb-2 uppercase italic">Building Teamwork</h4>
                                <p className="text-xs md:text-sm text-white/60 font-medium">ผจญภัยท่ามกลางธรรมชาติเพื่อสร้างความไว้วางใจและการสื่อสารในทีม</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8 md:gap-16">
                        <div className="lg:w-5/12">
                            <span className="text-[10px] font-black text-forest/20 uppercase tracking-[0.4em] mb-2 md:mb-4 block">Get a Quote</span>
    ...
    return (
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="col-span-2">
                ...
                <input required name="companyName" type="text" className="w-full bg-surface border border-forest/5 rounded-2xl px-6 py-4 focus:ring-2 focus:ring-primary outline-none transition-all font-bold text-forest placeholder:text-forest/10" placeholder="e.g. Nongtung Strategy Co., Ltd." />
            </div>
            <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-forest/30 mb-2 block">Contact Person</label>
                <input required name="contactPerson" type="text" className="w-full bg-surface border border-forest/5 rounded-2xl px-6 py-4 focus:ring-2 focus:ring-primary outline-none transition-all font-bold text-forest placeholder:text-forest/10" placeholder="Your Name" />
            </div>
            <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-forest/30 mb-2 block">Phone / Line ID</label>
                <input required name="phone" type="text" className="w-full bg-surface border border-forest/5 rounded-2xl px-6 py-4 focus:ring-2 focus:ring-primary outline-none transition-all font-bold text-forest placeholder:text-forest/10" placeholder="08x-xxx-xxxx" />
            </div>
            <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-forest/30 mb-2 block">Group Size</label>
                <input required name="groupSize" type="text" className="w-full bg-surface border border-forest/5 rounded-2xl px-6 py-4 focus:ring-2 focus:ring-primary outline-none transition-all font-bold text-forest placeholder:text-forest/10" placeholder="e.g. 25 Pax" />
            </div>
            <div>
            ...
            <div className="col-span-2">
                ...
                <textarea name="requirements" className="w-full bg-surface border border-forest/5 rounded-2xl px-6 py-4 focus:ring-2 focus:ring-primary outline-none transition-all font-bold text-forest h-32 placeholder:text-forest/10" placeholder="Tell us more about your team and budget..."></textarea>
            </div>
            <div className="col-span-2 pt-4">
                <button disabled={isPending} type="submit" className="w-full bg-primary hover:bg-forest text-white py-5 rounded-full font-black uppercase text-[10px] tracking-[0.2em] transition-all shadow-xl hover:shadow-primary/20 transform hover:-translate-y-1 flex items-center justify-center gap-3 group disabled:opacity-50 disabled:cursor-not-allowed">
                    {isPending ? 'Sending...' : 'Ask for a Quote'} <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </button>
            </div>
        </form>
    );
